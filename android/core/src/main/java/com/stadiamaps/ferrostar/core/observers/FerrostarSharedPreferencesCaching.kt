...
/**
 * A SharedPreferences-based implementation of NavigationCache for Android.
 * This provides persistent storage for navigation data across app sessions.
 *
...
class FerrostarSharedPreferencesCaching(
    ...
    /**
     * Saves navigation data to SharedPreferences.
     * The ByteArray is converted to a Base64 string for storage.
     *
    ...
    /**
     * Loads navigation data from SharedPreferences.
     * Returns null if no data is found or if decoding fails.
     *
