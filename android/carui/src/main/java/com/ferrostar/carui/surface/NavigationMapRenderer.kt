...
class NavigationMapRenderer(carContext: CarContext, viewModel: NavigationViewModel) :
    SurfaceCallback {
  ...
  override fun onSurfaceAvailable(surfaceContainer: SurfaceContainer) {
    surfaceContainer.surface?.let { surface -> renderComposeView(surface, composeView) }
  }
