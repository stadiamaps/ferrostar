...
/**
 * Not all navigation apps will require a navigation delegate. In fact, we hope that most don't! In
 * case you do though, this sample implementation shows what you'll need to get started by
 * re-implementing the default behaviors of the core.
 */
