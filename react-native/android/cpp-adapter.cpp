...
// Automated testing checks Java_com_ferrostar_FerrostarModule and ferrostar
// by comparing the whole line here.
/*
Java_com_ferrostar_FerrostarModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return ferrostar::multiply(a, b);
}
*/

// Installer coming from FerrostarModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ferrostar_FerrostarModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return ferrostar::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ferrostar_FerrostarModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return ferrostar::cleanupRustCrate(*runtime);
}