...
struct ContentView: View {
    ...
    var body: some View {
        ...
        let core = FerrostarCore(valhallaEndopointUrl: valhallaUrl, profile: "auto", initialUserLocation: CLLocation(latitude: 42.13640615156194, longitude: -80.0863545447856), waypoints: [CLLocationCoordinate2D(latitude: 42.1550468279988, longitude: -80.0894362088786)])
