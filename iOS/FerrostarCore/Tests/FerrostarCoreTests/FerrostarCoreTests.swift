...
let valhallaEndpointUrl = URL(string: "https://api.stadiamaps.com/route/v1")!
let simpleRoute = """
{
  "routes": [
    {
...
""".data(using: .utf8)
let successfulResponse = HTTPURLResponse(url: valhallaEndpointUrl, statusCode: 200, httpVersion: "HTTP/1.1", headerFields: ["Content-Type": "application/json"])!
